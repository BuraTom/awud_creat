...
import 'package:awud_creat/pages/GoogleSignInApi.dart';
// import 'package:awud_app/pages/registration.dart';
import 'package:awud_creat/pages/registration.dart';
  ...
  void login(String email, password) async {
    ...
    try {
      Response response = await post(
          Uri.parse('http://$IpAddresse:8000/user/login'),
